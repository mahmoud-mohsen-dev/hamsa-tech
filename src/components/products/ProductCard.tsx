  ...
  return (
    <div className='relative w-full bg-white p-5 shadow-featured transition-all duration-300 ease-linear hover:shadow-featuredHovered'>
      ...
      <div className='h-[90px] lg:h-[80px] 2xl:h-[100px]'>
        <h3 className='mb-2.5 max-h-[22px] overflow-hidden font-openSans text-sm font-normal leading-[22px] text-gray-medium'>
          {category}
        </h3>
        <h4 className='mb-[12px] font-openSans text-base font-semibold leading-[24px] text-black-light xl:text-xs 2xl:text-base'>
          {title}
        </h4>
      ...
      <div className='item mt-2 flex justify-between'>
        ...
        <Btn className='flex items-center gap-2 bg-green-600 px-3 py-[5px] font-openSans text-sm font-semibold text-white shadow-none'>
          <FaPlus />
          <span>Add</span>
        </Btn>
      </div>
